...
function Cel(options) {
    ...
    if (!options) options = {};
    var type =    options.type || generic_options.type,
        ...
        innerText = options.innerText || generic_options.innerText,
        children = options.children || generic_options.children,
        style = options.style || generic_options.style;
    ...
    return (function () {
        ...
        //Add any specified inline styles
